...
const compact = (v: unknown) =>
  typeof v === 'number'
    ...
    : '—';
const date = (v: unknown, full = false) => (!v ? '—' : researchTime(v, full));
...
export const defaultAppsView: AppsViewState = {
  country: '',
  store: '',
  classification: '',
  loanVerdict: '',
        ...
        <div className="detail-heading">
          ...
          <div>
            ...
            <div className="detail-meta">
              ...
              <a href={storeSource(app)} target="_blank" rel="noopener noreferrer">
                <span>
                  {app.externalId} · {stores[app.store]}
                </span>
            ...
            <section className="panel padded">
              ...
              <dl className="facts">
                ...
                <div>
                  <dt>官网</dt>
                  <dd>
                    <External url={app.developerWebsite} />
                  </dd>
                </div>
                <div>
                  <dt>隐私协议</dt>
